...
public class ArchtypeAppIOSTest extends BaseIOSTest {

    public static final String BUNDLE_ID = "com.globile.Accenture.Archetype";
    ...
    public static void beforeClass() throws Exception {
        ...
        File app = new File(appDir, "Archetype.app.zip");
